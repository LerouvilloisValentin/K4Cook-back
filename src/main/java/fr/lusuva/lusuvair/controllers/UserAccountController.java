package fr.k4cook.K4Cook.controllers;

import static fr.k4cook.K4Cook.utils.ControllerUtils.checkErrors;
...
import fr.k4cook.K4Cook.dtos.auth.JwtAuthenticationResponse;
import fr.k4cook.K4Cook.dtos.auth.UserLoginDto;
import fr.k4cook.K4Cook.dtos.auth.UserRegisterDto;
import fr.k4cook.K4Cook.dtos.user.UserResponseDto;
import fr.k4cook.K4Cook.repositories.UserAccountRepository;
import fr.k4cook.K4Cook.services.UserAccountService;
...
public class UserAccountController {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "User successfully created", content = {
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "User successfully logged in", content = {
			@Content(mediaType = "application/json", schema = @Schema(implementation = JwtAuthenticationResponse.class)) }),
			@ApiResponse(responseCode = "400", description = "Validation failed", content = @Content) })
	@PostMapping("/login")
	...
	@ApiResponses(value = { @ApiResponse(responseCode = "200", description = "User successfully suspended", content = {
			@Content(mediaType = "application/json", schema = @Schema(implementation = UserResponseDto.class)) }), })
